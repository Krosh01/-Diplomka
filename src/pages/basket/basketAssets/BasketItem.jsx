...
import { addPrice, deletePrice, deleteTask } from '../../../redux/redusers/dataCrad'
            ...
            <div className='basketItem__info'>
                ...
                <div className='basketItem__info-bottom'>
                    <div className='basketItem__info-bottom_numbers'>
                        <button className='basketItem__info-bottom_minus' onClick={() => {dispath(deletePrice(item.id))}}></button>
                        <div className='basketItem__info-bottom_center'>{item.count}</div>
                        <button className='basketItem__info-bottom_plus' onClick={() => {dispath(addPrice(item.id))}}></button>
                    </div>
