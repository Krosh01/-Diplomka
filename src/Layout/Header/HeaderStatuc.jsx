        ...
        <nav className='headerS__nav'>
            ...
            <li>
                <ul className='headerS__item'>
                  ...
                  <li><Link to='/home'><img src={logo} className='headerS__item-logo' alt="logo"/></Link></li>
                  <li><Link to='/home'>ПОКУПАТЕЛЯМ</Link></li>
                  <li><Link to='/home'>О БРЕНДЕ</Link></li>
                  <li><Link to='/home'>ШОУРУМ</Link></li>
